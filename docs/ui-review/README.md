...
- 业主首页本轮收口：移除“页签示例页”结构，首屏改为调度任务板，展示常用航线、路线态势、预算、空域、在线运力、保险/货物规则和明确发单行动；无订单时也有常用航线、预计预算和最近订单空态，不再出现大片空白。
...
- 机主首页本轮收口：首屏改为资产与运力调度台，展示在线/忙碌/下线运力池、适航/三者险/维护合规门、设备队列和下一步操作；低保额或维护缺口设备显示“需补合规”，不再误导为可投放。
