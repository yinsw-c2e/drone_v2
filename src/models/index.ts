...
export interface PaymentOrder { id: string; orderId: string; capacityId?: string; idempotencyKey?: string; amountCent: number; mode: PaymentMode | string; status: PaymentStatus; provider: string; providerTradeNo: string; prepayId?: string; sdkParams?: PaymentSDKParams; createdAt: string; updatedAt: string; paidAt?: string; failedReason?: string }
